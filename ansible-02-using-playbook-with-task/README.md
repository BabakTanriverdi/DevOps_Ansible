...
- check for the users after you run and explain the different users on each hosts
...
-o one line
-m module name 
-b --become-user elevated privelleges
-a arguemnts
--list-hosts lists the hosts that we are working with
-i INVETORYFILE overrides invetory file in cmd
---
we have two files that list users 
- /etc/shadow (sensitive root)
- /etc/passwd

--
shell not idompotent 
yum idompotent
dnf idompotent
apt idompotent
package idompotent